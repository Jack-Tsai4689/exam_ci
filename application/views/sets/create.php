			...
			<div class="cen last">
				<table class="list_edit" border="0" width="100%" cellpadding="0" cellspacing="0">
	                <tr class="deep">
	                    ...
	                    <td width="80%"><INPUT type="text" class="input_field w250" id="setsname" name="setsname" size="15" maxlength="20" ></td>
	                </tr>
					<tr class="shallow" id="duty">
	                    <td align="center">考卷說明</td>
	                    <td><textarea name="intro" id="intro" cols="50" rows="4" placeholder="範例：1-20題是非題。21-40題選擇題共40題" ></textarea></td>
	                </tr>
	                <tr class="deep">
                    ...
                    <tr class="shallow">
                        ...
                        <td id="big_title">
                            ...
                            <div class="sub" id="sub">
                                <div>
                                    <label>大題</label><input style="width:40px; text-align:center;" type="text" class="input_field subsort" name="sub_sort[]" id="sub_sort" placeholder="順序"><label>　分數比重</label><input style="width:40px; text-align:center;" type="text" class="input_field subscore" name="sub_score[]" maxlength="4" id="sub_score">
                                    <label>%　</label>
                                </div>
                                <div>
                                    <label class="csub_intro">大題說明</label>
                                    <textarea name="sub_intro[]" class="subintro"></textarea>
                                </div>
                            </div>
                        </td>
                    </tr>
