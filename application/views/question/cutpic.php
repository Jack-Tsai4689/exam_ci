...
<div id="all">
	...
	<div class="content">
		<div class="cen">
			<form name="thumbnail" action="<?=site_url('/question/cut_act')?>" method="post" enctype="multipart/form-data" onsubmit="return check();">
                ...
                <div align="left">
					<img src=""
					             style="float: left; margin-right: 10px; width:1000px;" id="thumbnail" alt="Create Thumbnail" title="老師請在圖片上按滑鼠左鍵上下移動試試看，截取完題目範圍請點擊右下角的「圖片上傳」按鈕"/>
					<div id="fixedBottom" >
...
function check(){
	if(!confirm('這是您要的題目嗎?'))return false;
}
