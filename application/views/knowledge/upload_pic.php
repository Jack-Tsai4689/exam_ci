...
<div id="all">
	...
	<div class="content">
		<div class="cen">
            <FORM name="form1" id="form1" method="post" action="<?=site_url('/knowledge/upload_act')?>" enctype="multipart/form-data">
                <br>
            ...
            <form name="form2" id="form2" method="post" action="<?=site_url('/knowledge/qcutpic')?>">
